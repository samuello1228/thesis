...
\item Our detector is not perfect. There are two types of background in the data, which is due to the limitation of our detector.
\begin{itemize}
\item Charge flip background
\item Fake lepton background
\end{itemize}
\item They are due to the wrong identification of the particle.
\end{itemize}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{data/photo/charge_flip/Brem.jpg} \\
\includegraphics[width=0.5\textwidth]{data/photo/charge_flip/WrongTrack.png}
\end{figure}
\end{frame}
