...
\begin{frame}{Results: Observed Events (systematics)}
\begin{itemize}
\item The dominant systematic uncertainty is the systematic uncertainty from the fake lepton background.
\end{itemize}
\begin{table}[htbp]
\centering
