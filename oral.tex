...
\begin{frame}{Basic kinematic variables}
\begin{itemize}
\item $p_T$: It is designed to estimate the momentum of the lepton on the x-y plane. The transverse momentum $\bf{p}_T$ is the projection of $\bf{p}$ onto the x-y plane. The magnitude of $\bf{p}_T$ is denoted by $p_T$
\begin{equation*}
p_T = \sqrt{p_x^2 + p_y^2}
\end{equation*}
\item The lepton with larger $p_T$ is called the leading lepton, and the lepton with smaller $p_T$ is called the sub-leading lepton. $p_T^1$ is the $p_T$ of the leading lepton. $p_T^2$ is the $p_T$ of the sub-leading lepton.
\end{itemize}
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{data/photo/detector/impact_parameter.png}
...
\end{equation*}
\item It is designed to measure the polar angle $\theta$ of the particle.
