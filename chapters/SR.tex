...
This section describes how the signal region definition is optimizied.
...
\caption{Distributions of the kinematic variables used for the optimization in SRjet1. The pre-selections have been applied.}
