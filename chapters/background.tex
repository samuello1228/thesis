...
After the reconstruction, due to the charge-flipped leptons, there are $M^{ij}_{OS}$ opposite-sign events and $M^{ij}_{SS}$ same-sign events.
...
\end{figure}
Also, it turns out that the resulting measured charge-flip rate $\epsilon_i$ is about $10^{-3}$, as shown in figure \ref{fig:charge_flip_data_tot}.
